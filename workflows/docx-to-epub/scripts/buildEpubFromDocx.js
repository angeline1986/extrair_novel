...
import {
  ...
  escapeHtml,
  cleanText,
} from "../../../src/io/fileUtils.js";
import {
  readDocxText,
  parseVolumeFromDocx,
  sortDocxFiles,
  slugNumber,
} from "../../../src/io/docxReader.js";

// =====================================================
// Gera EPUB único a partir dos DOCX do workflow docx-to-epub/input/
// Estrutura esperada:
// Volume X
// Capítulo Y: ...
// parágrafos...
...
const INPUT_DIR = path.join(process.cwd(), "workflows/docx-to-epub/input");
const COVER_FILE = path.join(process.cwd(), "workflows/docx-to-epub/assets/cover2.jpg");

const OUTPUT_FILE = path.join(
  process.cwd(),
  "workflows/docx-to-epub/output/Winter_Field_PTBR_corrigido.epub"
);
...
const BUILD_DIR = path.join(process.cwd(), "workflows/docx-to-epub/output/.temp");
...
export const main = buildEpub;

if (process.argv[1]?.endsWith("buildEpubFromDocx.js")) {
  main().catch(err => {
